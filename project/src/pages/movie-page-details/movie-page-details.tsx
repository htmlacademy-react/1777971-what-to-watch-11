...
function MoviePageDetails({ films }: Props) {
  ...
  return (
    <>
      {films
        .filter((film) => id && film.id === +id)
        .map((film) => (
          <section key={film.name} className="film-card film-card--full">
              ...
              <div className="film-card__wrap">
                <div className="film-card__desc">
                  ...
                  <p className="film-card__meta">
                    {film.genres.map((genre)=>(<span key={genre} className="film-card__genre">{genre}</span>))}
                  ...
                  <div className="film-card__text film-card__row">
                    ...
                    <div className="film-card__text-col">
                      ...
                      <p className="film-card__details-item">
                        ...
                        <span className="film-card__details-value">{film.genres[0]}</span>
                      </p>
                      <p className="film-card__details-item">
                        <strong className="film-card__details-name">
                          Released
                        </strong>
                        <span className="film-card__details-value">{film.date}</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="catalog__films-list">
            <article className="small-film-card catalog__films-card">
              ...
              <h3 className="small-film-card__title">
                <Link className="small-film-card__link" to={`${AppRoute.Films}/${id || '1'}`}>
